...
`,J=function(t,e){return(0,R.d)(t,e)},wt=function(t,e){const l=t.append("circle").attr("cx",e.cx).attr("cy",e.cy).attr("class","face").attr("r",15).attr("stroke-width",2).attr("overflow","visible"),s=t.append("g");s.append("circle").attr("cx",e.cx-15/3).attr("cy",e.cy-15/3).attr("r",1.5).attr("stroke-width",2).attr("fill","#666").attr("stroke","#666"),s.append("circle").attr("cx",e.cx+15/3).attr("cy",e.cy-15/3).attr("r",1.5).attr("stroke-width",2).attr("fill","#666").attr("stroke","#666");function h(d){const _=(0,V.Nb1)().startAngle(Math.PI/2).endAngle(3*(Math.PI/2)).innerRadius(7.5).outerRadius(6.8181818181818175);d.append("path").attr("class","mouth").attr("d",_).attr("transform","translate("+e.cx+","+(e.cy+2)+")")}function c(d){const _=(0,V.Nb1)().startAngle(3*Math.PI/2).endAngle(5*(Math.PI/2)).innerRadius(7.5).outerRadius(6.8181818181818175);d.append("path").attr("class","mouth").attr("d",_).attr("transform","translate("+e.cx+","+(e.cy+7)+")")}function f(d){d.append("line").attr("class","mouth").attr("stroke",2).attr("x1",e.cx-5).attr("y1",e.cy+7).attr("x2",e.cx+5).attr("y2",e.cy+7).attr("class","mouth").attr("stroke-width","1px").attr("stroke","#666")}return e.score>3?h(s):e.score<3?c(s):f(s),l},ot=function(t,e){const r=t.append("circle");return r.attr("cx",e.cx),r.attr("cy",e.cy),r.attr("class","actor-"+e.pos),r.attr("fill",e.fill),r.attr("stroke",e.stroke),r.attr("r",e.r),r.class!==void 0&&r.attr("class",r.class),e.title!==void 0&&r.append("title").text(e.title),r},lt=function(t,e){return(0,R.f)(t,e)},Et=function(t,e){function r(s,h,c,f,d){return s+","+h+" "+(s+c)+","+h+" "+(s+c)+","+(h+f-d)+" "+(s+c-d*1.2)+","+(h+f)+" "+s+","+(h+f)}const l=t.append("polygon");l.attr("points",r(e.x,e.y,50,20,7)),l.attr("class","labelBox"),e.y=e.y+e.labelMargin,e.x=e.x+.5*e.labelMargin,lt(t,e)},Mt=function(t,e,r){const l=t.append("g"),s=(0,R.g)();s.x=e.x,s.y=e.y,s.fill=e.fill,s.width=r.width*e.taskCount+r.diagramMarginX*(e.taskCount-1),s.height=r.height,s.class="journey-section section-type-"+e.num,s.rx=3,s.ry=3,J(l,s),ht(r)(e.text,l,s.x,s.y,s.width,s.height,{class:"journey-section section-type-"+e.num},r,e.colour)};let ct=-1;const Tt=function(t,e,r){const l=e.x+r.width/2,s=t.append("g");ct++;const h=300+5*30;s.append("line").attr("id","task"+ct).attr("x1",l).attr("y1",e.y).attr("x2",l).attr("y2",h).attr("class","task-line").attr("stroke-width","1px").attr("stroke-dasharray","4 2").attr("stroke","#666"),wt(s,{cx:l,cy:300+(5-e.score)*30,score:e.score});const c=(0,R.g)();c.x=e.x,c.y=e.y,c.fill=e.fill,c.width=r.width,c.height=r.height,c.class="task task-type-"+e.num,c.rx=3,c.ry=3,J(s,c);let f=e.x+14;e.people.forEach(d=>{const _=e.actors[d].color,x={cx:f,cy:e.y,r:7,fill:_,stroke:"#000",title:d,pos:e.actors[d].position};ot(s,x),f+=10}),ht(r)(e.task,s,c.x,c.y,c.width,c.height,{class:"task"},r,e.colour)},Pt=function(t,e){(0,R.a)(t,e)},ht=function(){function t(s,h,c,f,d,_,x,g){const n=h.append("text").attr("x",c+d/2).attr("y",f+_/2+5).style("font-color",g).style("text-anchor","middle").text(s);l(n,x)}function e(s,h,c,f,d,_,x,g,n){const{taskFontSize:i,taskFontFamily:a}=g,y=s.split(/<br\s*\/?>/gi);for(let p=0;p<y.length;p++){const o=p*i-i*(y.length-1)/2,C=h.append("text").attr("x",c+d/2).attr("y",f).attr("fill",n).style("text-anchor","middle").style("font-size",i).style("font-family",a);C.append("tspan").attr("x",c+d/2).attr("dy",o).text(y[p]),C.attr("y",f+_/2).attr("dominant-baseline","central").attr("alignment-baseline","central"),l(C,x)}}function r(s,h,c,f,d,_,x,g){const n=h.append("switch"),a=n.append("foreignObject").attr("x",c).attr("y",f).attr("width",d).attr("height",_).attr("position","fixed").append("xhtml:div").style("display","table").style("height","100%").style("width","100%");a.append("div").attr("class","label").style("display","table-cell").style("text-align","center").style("vertical-align","middle").text(s),e(s,n,c,f,d,_,x,g),l(a,x)}function l(s,h){for(const c in h)c in h&&s.attr(c,h[c])}return function(s){return s.textPlacement==="fo"?r:s.textPlacement==="old"?t:e}}(),Y={drawRect:J,drawCircle:ot,drawSection:Mt,drawText:lt,drawLabel:Et,drawTask:Tt,drawBackgroundRect:Pt,initGraphics:function(t){t.append("defs").append("marker").attr("id","arrowhead").attr("refX",5).attr("refY",2).attr("markerWidth",6).attr("markerHeight",4).attr("orient","auto").append("path").attr("d","M 0,0 V 4 L6,2 Z")}},$t=function(t){Object.keys(t).forEach(function(r){U[r]=t[r]})},I={};function St(t){const e=(0,k.c)().journey;let r=60;Object.keys(I).forEach(l=>{const s=I[l].color,h={cx:20,cy:r,r:7,fill:s,stroke:"#000",pos:I[l].position};Y.drawCircle(t,h);const c={x:40,y:r+7,fill:"#666",text:l,textMargin:e.boxTextMargin|5};Y.drawText(t,c),r+=20})}const U=(0,k.c)().journey,B=U.leftMargin,It=function(t,e,r,l){const s=(0,k.c)().journey,h=(0,k.c)().securityLevel;let c;h==="sandbox"&&(c=(0,V.Ys)("#i"+e));const f=h==="sandbox"?(0,V.Ys)(c.nodes()[0].contentDocument.body):(0,V.Ys)("body");P.init();const d=f.select("#"+e);Y.initGraphics(d);const _=l.db.getTasks(),x=l.db.getDiagramTitle(),g=l.db.getActors();for(const o in I)delete I[o];let n=0;g.forEach(o=>{I[o]={color:s.actorColours[n%s.actorColours.length],position:n},n++}),St(d),P.insert(0,0,B,Object.keys(I).length*50),Ct(d,_,0);const i=P.getBounds();x&&d.append("text").text(x).attr("x",B).attr("font-size","4ex").attr("font-weight","bold").attr("y",25);const a=i.stopy-i.starty+2*s.diagramMarginY,y=B+i.stopx+2*s.diagramMarginX;(0,k.i)(d,a,y,s.useMaxWidth),d.append("line").attr("x1",B).attr("y1",s.height*4).attr("x2",y-B-4).attr("y2",s.height*4).attr("stroke-width",4).attr("stroke","black").attr("marker-end","url(#arrowhead)");const p=x?70:0;d.attr("viewBox",`${i.startx} -25 ${y} ${a+p}`),d.attr("preserveAspectRatio","xMinYMin meet"),d.attr("height",a+p+25)},P={data:{startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},verticalPos:0,sequenceItems:[],init:function(){this.sequenceItems=[],this.data={startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},this.verticalPos=0},updateVal:function(t,e,r,l){t[e]===void 0?t[e]=r:t[e]=l(r,t[e])},updateBounds:function(t,e,r,l){const s=(0,k.c)().journey,h=this;let c=0;function f(d){return function(x){c++;const g=h.sequenceItems.length-c+1;h.updateVal(x,"starty",e-g*s.boxMargin,Math.min),h.updateVal(x,"stopy",l+g*s.boxMargin,Math.max),h.updateVal(P.data,"startx",t-g*s.boxMargin,Math.min),h.updateVal(P.data,"stopx",r+g*s.boxMargin,Math.max),d!=="activation"&&(h.updateVal(x,"startx",t-g*s.boxMargin,Math.min),h.updateVal(x,"stopx",r+g*s.boxMargin,Math.max),h.updateVal(P.data,"starty",e-g*s.boxMargin,Math.min),h.updateVal(P.data,"stopy",l+g*s.boxMargin,Math.max))}}this.sequenceItems.forEach(f())},insert:function(t,e,r,l){const s=Math.min(t,r),h=Math.max(t,r),c=Math.min(e,l),f=Math.max(e,l);this.updateVal(P.data,"startx",s,Math.min),this.updateVal(P.data,"starty",c,Math.min),this.updateVal(P.data,"stopx",h,Math.max),this.updateVal(P.data,"stopy",f,Math.max),this.updateBounds(s,c,h,f)},bumpVerticalPos:function(t){this.verticalPos=this.verticalPos+t,this.data.stopy=this.verticalPos},getVerticalPos:function(){return this.verticalPos},getBounds:function(){return this.data}},Q=U.sectionFills,ut=U.sectionColours,Ct=function(t,e,r){const l=(0,k.c)().journey;let s="";const h=l.height*2+l.diagramMarginY,c=r+h;let f=0,d="#CCC",_="black",x=0;for(const[g,n]of e.entries()){if(s!==n.section){d=Q[f%Q.length],x=f%Q.length,_=ut[f%ut.length];let a=0;const y=n.section;for(let o=g;o<e.length&&e[o].section==y;o++)a=a+1;const p={x:g*l.taskMargin+g*l.width+B,y:50,text:n.section,fill:d,num:x,colour:_,taskCount:a};Y.drawSection(t,p,l),s=n.section,f++}const i=n.people.reduce((a,y)=>(I[y]&&(a[y]=I[y]),a),{});n.x=g*l.taskMargin+g*l.width+B,n.y=c,n.width=l.diagramMarginX,n.height=l.diagramMarginY,n.colour=_,n.fill=d,n.num=x,n.actors=i,Y.drawTask(t,n,l),P.insert(n.x,n.y,n.x+n.width+l.taskMargin,300+5*30)}},yt={setConf:$t,draw:It},At={parser:Z,db:at,renderer:yt,styles:vt,init:t=>{yt.setConf(t.journey),at.clear()}}},33463:function(gt,X,S){S.d(X,{a:function(){return nt},b:function(){return z},c:function(){return rt},d:function(){return R},e:function(){return O},f:function(){return st},g:function(){return Z}});var k=S(17967),V=S(92999);const R=(E,u)=>{const m=E.append("rect");if(m.attr("x",u.x),m.attr("y",u.y),m.attr("fill",u.fill),m.attr("stroke",u.stroke),m.attr("width",u.width),m.attr("height",u.height),u.rx!==void 0&&m.attr("rx",u.rx),u.ry!==void 0&&m.attr("ry",u.ry),u.attrs!==void 0)for(const v in u.attrs)m.attr(v,u.attrs[v]);return u.class!==void 0&&m.attr("class",u.class),m},nt=(E,u)=>{const m={x:u.startx,y:u.starty,width:u.stopx-u.startx,height:u.stopy-u.starty,fill:u.fill,stroke:u.stroke,class:"rect"};R(E,m).lower()},st=(E,u)=>{const m=u.text.replace(V.H," "),v=E.append("text");v.attr("x",u.x),v.attr("y",u.y),v.attr("class","legend"),v.style("text-anchor",u.anchor),u.class!==void 0&&v.attr("class",u.class);const T=v.append("tspan");return T.attr("x",u.x+u.textMargin*2),T.text(m),v},rt=(E,u,m,v)=>{const T=E.append("image");T.attr("x",u),T.attr("y",m);const W=(0,k.N)(v);T.attr("xlink:href",W)},z=(E,u,m,v)=>{const T=E.append("use");T.attr("x",u),T.attr("y",m);const W=(0,k.N)(v);T.attr("xlink:href",`#${W}`)},Z=()=>({x:0,y:0,width:100,height:100,fill:"#EDF2AE",stroke:"#666",anchor:"start",rx:0,ry:0}),O=()=>({x:0,y:0,width:100,height:100,"text-anchor":"start",style:"#666",textMargin:0,rx:0,ry:0,tspan:!0})}}]);

//# sourceMappingURL=8764.9519829fc4f19bcd01ce.js.map